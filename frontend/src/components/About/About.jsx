...
<<<<<<< HEAD
            For three decades, our commitment to excellence in emergency
            healthcare has made us a trusted name nationwide, consistently
            recognized as a leader in patient care and ranked at the top
            in our state. 
            </p>
            <p className="text__para mt-[30px]">
            Every day, we focus forward, dedicated to providing unparalleled
            care to those who need it most. Our mission is clear: to set
            new standards in emergency medical services, always striving
            to improve and innovate for a healthier tomorrow.
=======
