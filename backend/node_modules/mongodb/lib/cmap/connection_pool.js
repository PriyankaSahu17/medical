...
<<<<<<< HEAD
                this.emit(ConnectionPool.CONNECTION_CHECK_OUT_FAILED, new connection_pool_events_1.ConnectionCheckOutFailedEvent(this, reason, error));
=======
        ...
        while (this.waitQueueSize > 0 &&
            ...
            this.createConnection((err, connection) => {
                if (waitQueueMember[kCancelled]) {
                    ...
                    if (err) {
<<<<<<< HEAD
                        this.emit(ConnectionPool.CONNECTION_CHECK_OUT_FAILED, 
=======
